# AGENTS Guide: /apps/desktop/shell/src-tauri/src

## Scope
- Applies to `/apps/desktop/shell/src-tauri/src` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Rust source for desktop shell startup and bindings.
...
### Files
- `main.rs`: Desktop shell entrypoint wiring the Tauri host application.
