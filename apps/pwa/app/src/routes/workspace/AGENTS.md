# AGENTS Guide: /apps/pwa/app/src/routes/workspace

## Scope
- Applies to `/apps/pwa/app/src/routes/workspace` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Route for workspace-focused view mode.
