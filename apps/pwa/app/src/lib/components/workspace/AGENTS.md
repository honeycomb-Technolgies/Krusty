# AGENTS Guide: /apps/pwa/app/src/lib/components/workspace

## Scope
- Applies to `/apps/pwa/app/src/lib/components/workspace` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Workspace-level container components for composing views.
...
### Files
- `WorkspaceView.svelte`: Reusable Svelte component implementing Workspace View UI behavior.
