# AGENTS Guide: /crates/krusty-core/src/extensions/wasm_host

## Scope
- Applies to `/crates/krusty-core/src/extensions/wasm_host` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
WASM host runtime for executing extension modules.
...
## Structure Map
### Subdirectories
- `wit/`: Generated and maintained Rust bindings for WIT extension interfaces. See `crates/krusty-core/src/extensions/wasm_host/wit/AGENTS.md` for local detail.
