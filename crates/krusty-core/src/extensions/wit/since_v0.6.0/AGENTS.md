# AGENTS Guide: /crates/krusty-core/src/extensions/wit/since_v0.6.0

## Scope
- Applies to `/crates/krusty-core/src/extensions/wit/since_v0.6.0` and its direct contents.
...
- `context-server.wit`: WIT interface contract defining context server extension and runtime APIs.
- `dap.wit`: WIT interface contract defining dap extension and runtime APIs.
...
- `process.wit`: WIT interface contract defining process extension and runtime APIs.
