# AGENTS Guide: /crates/krusty-core/src/skills

## Scope
- Applies to `/crates/krusty-core/src/skills` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Filesystem skill discovery/loading and runtime skill metadata.
...
### Files
- `loader.rs`: Rust source module implementing loader behavior.
