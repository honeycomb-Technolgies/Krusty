# AGENTS Guide: /crates/krusty-core/src/ai/retry

## Scope
- Applies to `/crates/krusty-core/src/ai/retry` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Retry and backoff logic for resilient model calls.
...
### Files
- `backoff.rs`: Rust source module implementing backoff behavior.
