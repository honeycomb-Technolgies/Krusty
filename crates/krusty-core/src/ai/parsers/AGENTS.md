# AGENTS Guide: /crates/krusty-core/src/ai/parsers

## Scope
- Applies to `/crates/krusty-core/src/ai/parsers` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Provider output parsers for streamed/non-streamed model responses.
