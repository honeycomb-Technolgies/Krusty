# AGENTS Guide: /crates/krusty-core/src/updater

## Scope
- Applies to `/crates/krusty-core/src/updater` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Update checking logic for release/version notifications.
...
### Files
- `checker.rs`: Rust source module implementing checker behavior.
