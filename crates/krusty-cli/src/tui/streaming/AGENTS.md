# AGENTS Guide: /crates/krusty-cli/src/tui/streaming

## Scope
- Applies to `/crates/krusty-cli/src/tui/streaming` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
TUI streaming state types and adapters.
