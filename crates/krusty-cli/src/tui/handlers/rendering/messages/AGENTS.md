# AGENTS Guide: /crates/krusty-cli/src/tui/handlers/rendering/messages

## Scope
- Applies to `/crates/krusty-cli/src/tui/handlers/rendering/messages` and its direct contents.
- If a deeper directory has its own `AGENTS.md`, that file takes precedence for its subtree.

## Purpose
Message render helpers and selection behavior.
